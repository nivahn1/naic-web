...
export function RegistrationForm({
  ...
  const [selected, setSelected] = useState<string[]>([defaultWebinarSlug]);
    ...
    >
      ...
      <fieldset>
        ...
        <p className="mt-2 text-sm text-[var(--muted)]">
          Select one or more — $99 each. You&rsquo;ll pay for all of them in
          a single checkout.
        </p>
        ...
        <p className="mt-4 text-sm text-[var(--muted)]">
          ...
          for {selected.length} webinar{selected.length === 1 ? "" : "s"}
        </p>
      </fieldset>
