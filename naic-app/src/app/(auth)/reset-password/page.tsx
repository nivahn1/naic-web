    ...
    return (
      <div className="gradient-border rounded-3xl bg-white/[0.04] p-8 text-center backdrop-blur-xl">
        ...
        <Link
          ...
          className="mt-6 inline-flex rounded-xl bg-gradient-to-br from-[#00004d] to-violet-600 px-5 py-2.5 text-sm font-semibold text-white transition-transform hover:-translate-y-0.5"
        >
          Request a new link
        </Link>
      </div>
