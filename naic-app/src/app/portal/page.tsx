    ...
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-[1.3fr_1fr]">
        <div className="rounded-2xl border border-[var(--surface-border)] bg-[var(--surface)] p-6">
          ...
          <p className="font-display mt-2 text-3xl font-semibold tracking-tight text-slate-900 dark:text-white">
            {tier.name}
          ...
          <Link
            ...
            className="mt-5 inline-flex rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 px-4 py-2 text-sm font-semibold text-white transition-transform hover:-translate-y-0.5"
          >
            Manage membership
          </Link>
        </div>
      ...
      <h2 className="font-display mt-10 text-sm font-semibold uppercase tracking-[0.14em] text-violet-600 dark:text-violet-300">
        Member resources
      </h2>
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        {RESOURCES.map((r) => (
          ...
          >
            ...
            <span className="mt-3 inline-block text-sm font-semibold text-violet-600 dark:text-violet-300">
              {r.cta}{" "}
